...
////C
        _dataSource: function () {
            ...
            if (gridOptions.filterable) {
                gridOptions.filterable = extend(true, smart.kendoui.filterMessages, gridOptions.filterable);
            }

            if (gridOptions.pageable) {
                gridOptions.pageable = extend(true, { messages: smart.kendoui.pageMessages }, gridOptions.pageable);
            }
